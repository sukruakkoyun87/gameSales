...
public class NTEExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(NTEDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new NTEStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static NTEDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static NTEDateTimeConverter dateTimeConverter = new NTEStandardDateTimeConverter();

    public NTEExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public NTEExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new NTEMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=NTEHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,NTEExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=NTEHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
