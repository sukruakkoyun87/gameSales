...
public class NTEKPSPublicSoap
{
    ...
    public NTEKPSPublicSoap(){}

    public NTEKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public NTEKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        NTEExtendedSoapSerializationEnvelope envelope= new NTEExtendedSoapSerializationEnvelope(NTEExtendedSoapSerializationEnvelope.VER11);
